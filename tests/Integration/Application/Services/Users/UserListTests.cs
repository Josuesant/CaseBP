...
public class UserListTests : IntegrationBase
{
    ...
    public async Task Should_list_user()
    {
        ...
        userDto.UpdatedAt.Should().BeCloseTo(userDb.UltomaAtualizacao, TimeSpan.FromSeconds(1));
    ...
    public async Task Should_list_users_by_email()
    {
        ...
        firstUserDto.UpdatedAt.Should().BeCloseTo(firstUserDb.UltomaAtualizacao, TimeSpan.FromSeconds(1));
        ...
        lastUserDto.UpdatedAt.Should().BeCloseTo(lastUserDb.UltomaAtualizacao, TimeSpan.FromSeconds(1));
    ...
    public async Task Should_list_users_by_last_updated_at()
    {
        ...
        _listResponse = await _list.ListByAsync(new ListUsersRequestDto(CustomRequestedBy, Token)
            { UpdatedAt = _users.First().UltomaAtualizacao, OrderBy = new Dictionary<string, bool> { { "email", true } } });
